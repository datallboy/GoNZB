...
type UsenetIndexStore interface {
	...
	GetIndexerBacklogStats(ctx context.Context) (*pgindex.IndexerBacklogStats, error)
	RefreshIndexerBacklogStats(ctx context.Context) (*pgindex.IndexerBacklogStats, error)
