--
-- GoNZB v0.9.0 PostgreSQL baseline (schema version 36).
--
-- Generated from a clean PostgreSQL 17.10 database after applying migrations
-- 001 through 036. New installations apply this canonical schema directly;
-- versioned v0.8 installations retain the incremental upgrade path.
...
--
-- Name: article_availability_attestations; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.article_availability_attestations (
    ...
    articles_total integer DEFAULT 0 NOT NULL,
    articles_available integer DEFAULT 0 NOT NULL,
    missing_articles integer DEFAULT 0 NOT NULL,
    provider_backbone_hash text,
    retention_days_observed integer DEFAULT 0 NOT NULL,
...
CREATE TABLE public.article_cohort_candidates (
    ...
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    recovery_decision text DEFAULT 'sample'::text NOT NULL,
    stable_signal_key text DEFAULT ''::text NOT NULL,
    stable_signal_count integer DEFAULT 0 NOT NULL,
    grouping_gain_count integer DEFAULT 0 NOT NULL,
    decision_article_count integer DEFAULT 0 NOT NULL,
    ...
    CONSTRAINT article_cohort_candidates_recovery_decision_check CHECK ((recovery_decision = ANY (ARRAY['sample'::text, 'promoted'::text, 'no_yield'::text]))),
...
--
-- Name: binary_peer_segments; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.binary_peer_segments (
    peer_segment_id bigint NOT NULL,
    binary_id bigint NOT NULL,
    source_posted_at timestamp with time zone NOT NULL,
    part_number integer NOT NULL,
    ...
    segment_bytes bigint DEFAULT 0 NOT NULL,
    posted_at timestamp with time zone,
    observed_groups jsonb DEFAULT '[]'::jsonb NOT NULL,
    file_name text DEFAULT ''::text NOT NULL,
    file_size bigint DEFAULT 0 NOT NULL,
    source_pool_id text NOT NULL,
    source_node_id text NOT NULL,
    source_bundle_id text NOT NULL,
    acceptance_state text DEFAULT 'accepted'::text NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT binary_peer_segments_acceptance_state_check CHECK ((acceptance_state = ANY (ARRAY['accepted'::text, 'quarantined'::text, 'rejected'::text])))
);


--
-- Name: binary_effective_parts; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.binary_effective_parts AS
 SELECT bp.binary_id,
    bp.source_posted_at,
    bp.part_number,
    bp.total_parts,
    ...
    COALESCE(ah.article_number, (0)::bigint) AS article_number,
    COALESCE(( SELECT jsonb_agg(DISTINCT cg.observed_group_name ORDER BY cg.observed_group_name) AS jsonb_agg
           FROM public.article_header_crosspost_groups cg
          WHERE ((cg.source_posted_at = bp.source_posted_at) AND (cg.article_header_id = bp.article_header_id))), '[]'::jsonb) AS observed_groups,
    'local'::text AS part_source
   FROM (public.binary_parts bp
     LEFT JOIN public.article_headers ah ON (((ah.source_posted_at = bp.source_posted_at) AND (ah.id = bp.article_header_id))))
UNION ALL
 SELECT ps.binary_id,
    ps.source_posted_at,
    ps.part_number,
   ...
   FROM public.binary_peer_segments ps
  WHERE ((ps.acceptance_state = 'accepted'::text) AND (NOT (EXISTS ( SELECT 1
           FROM public.binary_parts local
          WHERE ((local.binary_id = ps.binary_id) AND (local.part_number = ps.part_number))))));


--
-- Name: binary_evidence_exchange_diagnostics; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.binary_evidence_exchange_diagnostics (
    ...
    body_requests_avoided integer DEFAULT 0 NOT NULL,
    response_bytes bigint DEFAULT 0 NOT NULL,
    conflicts integer DEFAULT 0 NOT NULL,
    quarantines integer DEFAULT 0 NOT NULL,
    latency_ms bigint DEFAULT 0 NOT NULL,
    error_text text DEFAULT ''::text NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT binary_evidence_exchange_diagnostics_direction_check CHECK ((direction = ANY (ARRAY['consume'::text, 'serve'::text]))),
    CONSTRAINT binary_evidence_exchange_diagnostics_evidence_kind_check CHECK ((evidence_kind = ANY (ARRAY['yenc'::text, 'segments'::text])))
);


--
-- Name: binary_evidence_exchange_diagnostics_diagnostic_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.binary_evidence_exchange_diagnostics_diagnostic_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: binary_evidence_exchange_diagnostics_diagnostic_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.binary_evidence_exchange_diagnostics_diagnostic_id_seq OWNED BY public.binary_evidence_exchange_diagnostics.diagnostic_id;


--
-- Name: binary_evidence_repair_work_items; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.binary_evidence_repair_work_items (
    binary_id bigint NOT NULL,
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT binary_evidence_repair_work_items_status_check CHECK ((status = ANY (ARRAY['ready'::text, 'running'::text, 'done'::text, 'stale'::text])))
);


--
-- Name: binary_exchange_identities; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.binary_exchange_identities (
    binary_id bigint NOT NULL,
    scheme text NOT NULL,
    match_id text NOT NULL,
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT binary_exchange_identities_scheme_check CHECK ((scheme = ANY (ARRAY['subject_multipart_v1'::text, 'yenc_v1'::text, 'content_v1'::text])))
);
...
--
-- Name: binary_peer_segments_peer_segment_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.binary_peer_segments_peer_segment_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: binary_peer_segments_peer_segment_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.binary_peer_segments_peer_segment_id_seq OWNED BY public.binary_peer_segments.peer_segment_id;
...
--
-- Name: checksum_attestations; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.checksum_attestations (
    attestation_id text NOT NULL,
    release_id text NOT NULL,
    manifest_id text NOT NULL,
    author_node_id text NOT NULL,
    ...
    checked_at timestamp with time zone NOT NULL,
    status text NOT NULL,
    checksums_total integer DEFAULT 0 NOT NULL,
    checksums_verified integer DEFAULT 0 NOT NULL,
    checksums_failed integer DEFAULT 0 NOT NULL,
    confidence double precision DEFAULT 0 NOT NULL,
    checksum_score double precision DEFAULT 0 NOT NULL,
    method text,
    body_json jsonb DEFAULT '{}'::jsonb NOT NULL,
    source_event_id text NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
...
--
-- Name: coverage_assignments; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: coverage_checkpoints; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.coverage_checkpoints (
    checkpoint_id text NOT NULL,
    pool_id text NOT NULL,
    group_name text NOT NULL,
    low_watermark bigint DEFAULT 0 NOT NULL,
...
--
-- Name: coverage_claims; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.coverage_claims (
    ...
    provider_scope_hash text,
    claim_mode text,
    expected_checkpoint_interval_seconds integer
);


--
-- Name: coverage_group_observations; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.coverage_group_observations (
...
--
-- Name: coverage_range_outcomes; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.coverage_range_outcomes (
...
--
-- Name: coverage_stale_claim_penalties; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.coverage_stale_claim_penalties (
    claim_id text NOT NULL,
    node_id text NOT NULL,
    pool_id text NOT NULL,
    group_name text NOT NULL,
    expired_at timestamp with time zone NOT NULL,
    penalty_score double precision DEFAULT 0 NOT NULL,
    reason text DEFAULT 'stale_claim'::text NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL
);
...
--
-- Name: federated_manifest_sources; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.federated_manifest_sources (
    manifest_id text NOT NULL,
    release_id text,
    source_node_id text NOT NULL,
    pool_id text NOT NULL,
...
--
-- Name: federated_release_cards; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.federated_release_cards (
    release_id text NOT NULL,
    manifest_id text,
    title text NOT NULL,
    normalized_title text NOT NULL,
    category_json jsonb DEFAULT '[]'::jsonb NOT NULL,
    newznab_categories jsonb DEFAULT '[]'::jsonb NOT NULL,
    ...
    manifest_confidence_score double precision DEFAULT 0 NOT NULL,
    trust_score double precision DEFAULT 0 NOT NULL,
...
--
-- Name: federated_release_sources; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.federated_release_sources (
    release_id text NOT NULL,
    manifest_id text,
    source_node_id text NOT NULL,
    source_event_id text NOT NULL,
    ...
    validation_score double precision DEFAULT 0 NOT NULL,
    validation_attestation_count integer DEFAULT 0 NOT NULL,
    checksum_score double precision DEFAULT 0 NOT NULL
);


--
-- Name: federation_activity_rollups; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.federation_activity_rollups (
    bucket_start timestamp with time zone NOT NULL,
    bucket_seconds integer NOT NULL,
    node_id text DEFAULT ''::text NOT NULL,
    pool_id text DEFAULT ''::text NOT NULL,
    component text NOT NULL,
    job text NOT NULL,
    attempts bigint DEFAULT 0 NOT NULL,
    successes bigint DEFAULT 0 NOT NULL,
    failures bigint DEFAULT 0 NOT NULL,
    items_in bigint DEFAULT 0 NOT NULL,
    items_out bigint DEFAULT 0 NOT NULL,
...
--
-- Name: federation_event_chain_issues; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.federation_event_chain_issues (
    id bigint NOT NULL,
    author_node_id text NOT NULL,
    ...
    CONSTRAINT federation_event_chain_issues_issue_type_check CHECK ((issue_type = ANY (ARRAY['sequence_gap'::text, 'fork'::text])))
);


--
-- Name: federation_event_chain_issues_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.federation_event_chain_issues_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: federation_event_chain_issues_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.federation_event_chain_issues_id_seq OWNED BY public.federation_event_chain_issues.id;


--
-- Name: federation_events; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.federation_events (
    ...
    pool_ids jsonb DEFAULT '[]'::jsonb NOT NULL,
    visibility text DEFAULT 'pool'::text NOT NULL,
    created_at timestamp with time zone NOT NULL,
...
--
-- Name: federation_node_capabilities; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.federation_node_capabilities (
    node_id text NOT NULL,
    capabilities jsonb DEFAULT '{}'::jsonb NOT NULL,
    module_status jsonb DEFAULT '{}'::jsonb NOT NULL,
...
CREATE TABLE public.federation_nodes (
    ...
    local_trust_score double precision DEFAULT 0 NOT NULL,
...
--
-- Name: federation_nonce_replay_cache; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.federation_nonce_replay_cache (
    node_id text NOT NULL,
    nonce text NOT NULL,
...
--
-- Name: federation_peer_deliveries; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.federation_peer_deliveries (
    peer_id bigint NOT NULL,
    event_id text NOT NULL,
    status text DEFAULT 'pending'::text NOT NULL,
    attempts integer DEFAULT 0 NOT NULL,
...
--
-- Name: federation_peers_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.federation_peers_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: federation_peers_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.federation_peers_id_seq OWNED BY public.federation_peers.id;


--
-- Name: federation_pending_projections; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.federation_pending_projections (
    event_id text NOT NULL,
    event_type text NOT NULL,
...
--
-- Name: federation_pool_admissions; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.federation_pool_admissions (
...
--
-- Name: federation_pool_approval_fragments; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.federation_pool_approval_fragments (
    proposal_event_id text NOT NULL,
...
--
-- Name: federation_rejected_events; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.federation_rejected_events (
    id bigint NOT NULL,
    event_id text,
    author_node_id text,
    event_type text,
...
--
-- Name: federation_rejected_events_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.federation_rejected_events_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: federation_rejected_events_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.federation_rejected_events_id_seq OWNED BY public.federation_rejected_events.id;


--
-- Name: federation_validation_tasks; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.federation_validation_tasks (
    task_id bigint NOT NULL,
    manifest_id text NOT NULL,
    release_id text NOT NULL,
    source_node_id text,
    source_event_id text,
    pool_id text DEFAULT 'pool.local'::text NOT NULL,
    status text DEFAULT 'pending'::text NOT NULL,
    priority integer DEFAULT 0 NOT NULL,
    attempts integer DEFAULT 0 NOT NULL,
    last_error text,
...
--
-- Name: federation_validation_tasks_task_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.federation_validation_tasks_task_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: federation_validation_tasks_task_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.federation_validation_tasks_task_id_seq OWNED BY public.federation_validation_tasks.task_id;


--
-- Name: gonzbnet_scan_output_publications; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.gonzbnet_scan_output_publications (
...
--
-- Name: gonzbnet_scan_outputs; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.gonzbnet_scan_outputs (
    scan_id text NOT NULL,
    body_json jsonb NOT NULL,
    status text DEFAULT 'pending'::text NOT NULL,
...
--
-- Name: health_attestations; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.health_attestations (
    attestation_id text NOT NULL,
    manifest_id text,
    release_id text NOT NULL,
    author_node_id text NOT NULL,
    ...
    repair_confidence double precision DEFAULT 0 NOT NULL,
    provider_backbone_hash text,
...
--
-- Name: indexer_article_cohort_scan_state; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.indexer_article_cohort_scan_state (
    ...
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT indexer_article_cohort_scan_state_cursor_check CHECK ((((cursor_posted_at IS NULL) AND (cursor_binary_id IS NULL)) OR ((cursor_posted_at IS NOT NULL) AND (cursor_binary_id IS NOT NULL)))),
    CONSTRAINT indexer_article_cohort_scan_state_window_check CHECK ((window_start < window_end))
);


--
-- Name: indexer_body_request_budget_state; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.indexer_body_request_budget_state (
    budget_key text NOT NULL,
    window_started_at timestamp with time zone DEFAULT date_trunc('hour'::text, now()) NOT NULL,
    requests_used bigint DEFAULT 0 NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT indexer_body_request_budget_state_key_check CHECK ((budget_key = ANY (ARRAY['recover_yenc_balanced'::text, 'recover_yenc_exhaustive'::text, 'inspect_discovery'::text]))),
    CONSTRAINT indexer_body_request_budget_state_used_check CHECK ((requests_used >= 0))
);
...
--
-- Name: indexer_inspection_reconcile_state; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.indexer_inspection_reconcile_state (
    stage_name text NOT NULL,
    cursor_updated_at timestamp with time zone DEFAULT '1970-01-01 00:00:00+00'::timestamp with time zone NOT NULL,
    cursor_release_id text DEFAULT ''::text NOT NULL,
    reconciled_count bigint DEFAULT 0 NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT indexer_inspection_reconcile_state_stage_check CHECK ((stage_name = ANY (ARRAY['inspect_discovery'::text, 'inspect_par2'::text, 'inspect_archive'::text, 'inspect_media'::text])))
);
...
CREATE TABLE public.indexer_recovery_capacity_state (
    ...
    latest_reserve_percent integer DEFAULT 10 NOT NULL,
    recovery_profile text DEFAULT 'balanced'::text NOT NULL,
    balanced_body_requests_per_hour bigint DEFAULT 25000 NOT NULL,
    exhaustive_body_requests_per_hour bigint DEFAULT 100000 NOT NULL,
    discovery_body_requests_per_hour bigint DEFAULT 1000 NOT NULL,
    CONSTRAINT indexer_recovery_capacity_state_id_check CHECK (id),
    CONSTRAINT indexer_recovery_capacity_state_latest_reserve_percent_check CHECK (((latest_reserve_percent >= 0) AND (latest_reserve_percent <= 50))),
    CONSTRAINT indexer_recovery_capacity_state_profile_check CHECK ((recovery_profile = ANY (ARRAY['header_only'::text, 'balanced'::text, 'exhaustive'::text])))
);
...
--
-- Name: indexer_scrape_timeframe_progress; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.indexer_scrape_timeframe_progress (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT indexer_scrape_timeframe_progress_range_check CHECK ((((article_low = 0) AND (article_high = 0)) OR ((article_low > 0) AND (article_high >= article_low)))),
    CONSTRAINT indexer_scrape_timeframe_progress_state_check CHECK ((state = ANY (ARRAY['pending'::text, 'active'::text, 'completed'::text, 'empty'::text, 'failed'::text]))),
    CONSTRAINT indexer_scrape_timeframe_progress_window_check CHECK ((window_end > window_start))
);


--
-- Name: indexer_source_bucket_state; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.indexer_source_bucket_state (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT indexer_source_bucket_state_state_check CHECK ((state = ANY (ARRAY['active'::text, 'success'::text, 'no_yield'::text, 'purge_eligible'::text, 'purged'::text])))
);
...
--
-- Name: manifest_availability_attestations; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.manifest_availability_attestations (
    attestation_id text NOT NULL,
    release_id text NOT NULL,
    manifest_id text NOT NULL,
    author_node_id text NOT NULL,
    ...
    wire_updated_at timestamp with time zone NOT NULL
);
...
--
-- Name: pool_members; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: resolution_manifests; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.resolution_manifests (
    manifest_id text NOT NULL,
    release_id text NOT NULL,
    source_node_id text,
    source_event_id text,
    encoding text DEFAULT 'jcs-json'::text NOT NULL,
    compression text,
    encrypted boolean DEFAULT false NOT NULL,
...
--
-- Name: role_federation_pool_access; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.role_federation_pool_access (
    role_id text NOT NULL,
    pool_id text NOT NULL,
    can_search boolean DEFAULT true NOT NULL,
    can_get boolean DEFAULT true NOT NULL,
    can_resolve_manifest boolean DEFAULT false NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL
);
...
--
-- Name: scanner_capacities; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.scanner_capacities (
    node_id text NOT NULL,
    published_at timestamp with time zone NOT NULL,
    groups_json jsonb DEFAULT '[]'::jsonb NOT NULL,
    max_ranges_per_hour integer DEFAULT 0 NOT NULL,
    max_bytes_per_hour bigint DEFAULT 0 NOT NULL,
    body_json jsonb DEFAULT '{}'::jsonb NOT NULL,
    source_event_id text NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    pool_id text,
    max_groups integer,
    max_articles_per_hour bigint,
    max_header_bytes_per_hour bigint,
    preferred_group_patterns jsonb,
    excluded_group_patterns jsonb,
    supports_article_range_scan boolean,
    supports_time_window_scan boolean,
    retention_days_observed integer,
    provider_scope_hash text
);
...
--
-- Name: scanner_heartbeats; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.scanner_heartbeats (
    node_id text NOT NULL,
    pool_id text NOT NULL,
    published_at timestamp with time zone NOT NULL,
    groups_json jsonb DEFAULT '[]'::jsonb NOT NULL,
    active_claims_json jsonb DEFAULT '[]'::jsonb NOT NULL,
    status text NOT NULL,
    body_json jsonb DEFAULT '{}'::jsonb NOT NULL,
    source_event_id text NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    queue_depth integer,
    current_articles_per_minute bigint
);
...
--
-- Name: tombstone_votes; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.tombstone_votes (
    id bigint NOT NULL,
...
--
-- Name: tombstone_votes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.tombstone_votes_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: tombstone_votes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.tombstone_votes_id_seq OWNED BY public.tombstone_votes.id;
...
--
-- Name: trust_pools; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.trust_pools (
    pool_id text NOT NULL,
    display_name text NOT NULL,
    description text,
    genesis_event_id text,
    policy_json jsonb DEFAULT '{}'::jsonb NOT NULL,
    membership_threshold integer DEFAULT 1 NOT NULL,
    moderation_threshold integer DEFAULT 1 NOT NULL,
    checkpoint_witness_threshold integer DEFAULT 1 NOT NULL,
    accept_mode text DEFAULT 'pool_member'::text NOT NULL,
    min_node_trust_score double precision DEFAULT 0 NOT NULL,
    accepted_event_types jsonb DEFAULT '["ReleaseCard", "HealthAttestation", "TrustAttestation", "Tombstone", "ValidatorCapacity", "ArticleAvailabilityAttestation", "ChecksumAttestation", "ManifestAvailability", "ScannerCapacity", "ScannerHeartbeat", "GroupObservation", "CoveragePlan", "CoverageAssignment", "RangeClaim", "TimeWindowClaim", "CoverageCheckpoint", "RangeComplete", "RangeFailed"]'::jsonb NOT NULL,
    enabled boolean DEFAULT true NOT NULL,
    ...
    admission_enabled boolean DEFAULT true NOT NULL
);
...
--
-- Name: user_federation_pool_access; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.user_federation_pool_access (
...
--
-- Name: yenc_header_evidence; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.yenc_header_evidence (
    ...
    total_parts integer DEFAULT 0 NOT NULL,
    file_size bigint DEFAULT 0 NOT NULL,
    part_begin bigint DEFAULT 0 NOT NULL,
    part_end bigint DEFAULT 0 NOT NULL,
    provenance text NOT NULL,
    source_pool_id text DEFAULT ''::text NOT NULL,
    source_node_id text DEFAULT ''::text NOT NULL,
    source_bundle_id text DEFAULT ''::text NOT NULL,
    acceptance_state text DEFAULT 'accepted'::text NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT yenc_header_evidence_acceptance_state_check CHECK ((acceptance_state = ANY (ARRAY['accepted'::text, 'quarantined'::text, 'rejected'::text]))),
    CONSTRAINT yenc_header_evidence_provenance_check CHECK ((provenance = ANY (ARRAY['local_body'::text, 'peer'::text])))
);


--
-- Name: yenc_header_evidence_evidence_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.yenc_header_evidence_evidence_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: yenc_header_evidence_evidence_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.yenc_header_evidence_evidence_id_seq OWNED BY public.yenc_header_evidence.evidence_id;
...
--
-- Name: binary_evidence_exchange_diagnostics diagnostic_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.binary_evidence_exchange_diagnostics ALTER COLUMN diagnostic_id SET DEFAULT nextval('public.binary_evidence_exchange_diagnostics_diagnostic_id_seq'::regclass);
...
--
-- Name: binary_peer_segments peer_segment_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.binary_peer_segments ALTER COLUMN peer_segment_id SET DEFAULT nextval('public.binary_peer_segments_peer_segment_id_seq'::regclass);
...
--
-- Name: federation_event_chain_issues id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_event_chain_issues ALTER COLUMN id SET DEFAULT nextval('public.federation_event_chain_issues_id_seq'::regclass);


--
-- Name: federation_peers id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_peers ALTER COLUMN id SET DEFAULT nextval('public.federation_peers_id_seq'::regclass);


--
-- Name: federation_rejected_events id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_rejected_events ALTER COLUMN id SET DEFAULT nextval('public.federation_rejected_events_id_seq'::regclass);


--
-- Name: federation_validation_tasks task_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_validation_tasks ALTER COLUMN task_id SET DEFAULT nextval('public.federation_validation_tasks_task_id_seq'::regclass);
...
--
-- Name: tombstone_votes id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tombstone_votes ALTER COLUMN id SET DEFAULT nextval('public.tombstone_votes_id_seq'::regclass);
...
--
-- Name: yenc_header_evidence evidence_id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.yenc_header_evidence ALTER COLUMN evidence_id SET DEFAULT nextval('public.yenc_header_evidence_evidence_id_seq'::regclass);


--
-- Name: article_availability_attestations article_availability_attestations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.article_availability_attestations
    ADD CONSTRAINT article_availability_attestations_pkey PRIMARY KEY (attestation_id);
...
--
-- Name: binary_evidence_exchange_diagnostics binary_evidence_exchange_diagnostics_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.binary_evidence_exchange_diagnostics
    ADD CONSTRAINT binary_evidence_exchange_diagnostics_pkey PRIMARY KEY (diagnostic_id);


--
-- Name: binary_evidence_repair_work_items binary_evidence_repair_work_items_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.binary_evidence_repair_work_items
    ADD CONSTRAINT binary_evidence_repair_work_items_pkey PRIMARY KEY (binary_id);


--
-- Name: binary_exchange_identities binary_exchange_identities_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.binary_exchange_identities
    ADD CONSTRAINT binary_exchange_identities_pkey PRIMARY KEY (binary_id, scheme);
...
--
-- Name: binary_peer_segments binary_peer_segments_binary_id_part_number_message_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.binary_peer_segments
    ADD CONSTRAINT binary_peer_segments_binary_id_part_number_message_id_key UNIQUE (binary_id, part_number, message_id);


--
-- Name: binary_peer_segments binary_peer_segments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.binary_peer_segments
    ADD CONSTRAINT binary_peer_segments_pkey PRIMARY KEY (peer_segment_id);
...
--
-- Name: checksum_attestations checksum_attestations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.checksum_attestations
    ADD CONSTRAINT checksum_attestations_pkey PRIMARY KEY (attestation_id);


--
-- Name: coverage_assignments coverage_assignments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coverage_assignments
    ADD CONSTRAINT coverage_assignments_pkey PRIMARY KEY (assignment_id);


--
-- Name: coverage_checkpoints coverage_checkpoints_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coverage_checkpoints
    ADD CONSTRAINT coverage_checkpoints_pkey PRIMARY KEY (checkpoint_id);


--
-- Name: coverage_claims coverage_claims_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coverage_claims
    ADD CONSTRAINT coverage_claims_pkey PRIMARY KEY (claim_id);


--
-- Name: coverage_group_observations coverage_group_observations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coverage_group_observations
    ADD CONSTRAINT coverage_group_observations_pkey PRIMARY KEY (observation_id);


--
-- Name: coverage_plans coverage_plans_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coverage_plans
    ADD CONSTRAINT coverage_plans_pkey PRIMARY KEY (plan_id);


--
-- Name: coverage_range_outcomes coverage_range_outcomes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coverage_range_outcomes
    ADD CONSTRAINT coverage_range_outcomes_pkey PRIMARY KEY (outcome_id);


--
-- Name: coverage_stale_claim_penalties coverage_stale_claim_penalties_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coverage_stale_claim_penalties
    ADD CONSTRAINT coverage_stale_claim_penalties_pkey PRIMARY KEY (claim_id);
...
--
-- Name: federated_manifest_sources federated_manifest_sources_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federated_manifest_sources
    ADD CONSTRAINT federated_manifest_sources_pkey PRIMARY KEY (manifest_id, source_node_id, pool_id);


--
-- Name: federated_release_cards federated_release_cards_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federated_release_cards
    ADD CONSTRAINT federated_release_cards_pkey PRIMARY KEY (release_id);


--
-- Name: federated_release_sources federated_release_sources_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federated_release_sources
    ADD CONSTRAINT federated_release_sources_pkey PRIMARY KEY (release_id, source_node_id, pool_id);


--
-- Name: federation_activity_rollups federation_activity_rollups_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_activity_rollups
    ADD CONSTRAINT federation_activity_rollups_pkey PRIMARY KEY (bucket_start, bucket_seconds, node_id, pool_id, component);


--
-- Name: federation_event_chain_issues federation_event_chain_issues_author_node_id_event_id_issue_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_event_chain_issues
    ADD CONSTRAINT federation_event_chain_issues_author_node_id_event_id_issue_key UNIQUE (author_node_id, event_id, issue_type);


--
-- Name: federation_event_chain_issues federation_event_chain_issues_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_event_chain_issues
    ADD CONSTRAINT federation_event_chain_issues_pkey PRIMARY KEY (id);


--
-- Name: federation_events federation_events_author_node_id_sequence_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_events
    ADD CONSTRAINT federation_events_author_node_id_sequence_key UNIQUE (author_node_id, sequence);


--
-- Name: federation_events federation_events_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_events
    ADD CONSTRAINT federation_events_pkey PRIMARY KEY (event_id);


--
-- Name: federation_node_capabilities federation_node_capabilities_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_node_capabilities
    ADD CONSTRAINT federation_node_capabilities_pkey PRIMARY KEY (node_id);
...
ALTER TABLE ONLY public.federation_nodes
    ADD CONSTRAINT federation_nodes_pkey PRIMARY KEY (node_id);


--
-- Name: federation_nonce_replay_cache federation_nonce_replay_cache_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_nonce_replay_cache
    ADD CONSTRAINT federation_nonce_replay_cache_pkey PRIMARY KEY (node_id, nonce);
...
ALTER TABLE ONLY public.federation_peer_cursors
    ADD CONSTRAINT federation_peer_cursors_pkey PRIMARY KEY (peer_id, pool_id, event_type);


--
-- Name: federation_peer_deliveries federation_peer_deliveries_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_peer_deliveries
    ADD CONSTRAINT federation_peer_deliveries_pkey PRIMARY KEY (peer_id, event_id);


--
-- Name: federation_peers federation_peers_peer_url_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_peers
    ADD CONSTRAINT federation_peers_peer_url_key UNIQUE (peer_url);
...
--
-- Name: federation_pending_projections federation_pending_projections_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_pending_projections
    ADD CONSTRAINT federation_pending_projections_pkey PRIMARY KEY (event_id);


--
-- Name: federation_pool_admissions federation_pool_admissions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_pool_admissions
    ADD CONSTRAINT federation_pool_admissions_pkey PRIMARY KEY (proposal_event_id);


--
-- Name: federation_pool_approval_fragments federation_pool_approval_fragments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_pool_approval_fragments
    ADD CONSTRAINT federation_pool_approval_fragments_pkey PRIMARY KEY (proposal_event_id, admin_node_id);


--
-- Name: federation_rejected_events federation_rejected_events_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_rejected_events
    ADD CONSTRAINT federation_rejected_events_pkey PRIMARY KEY (id);


--
-- Name: federation_validation_tasks federation_validation_tasks_manifest_id_pool_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_validation_tasks
    ADD CONSTRAINT federation_validation_tasks_manifest_id_pool_id_key UNIQUE (manifest_id, pool_id);


--
-- Name: federation_validation_tasks federation_validation_tasks_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_validation_tasks
    ADD CONSTRAINT federation_validation_tasks_pkey PRIMARY KEY (task_id);


--
-- Name: gonzbnet_scan_output_publications gonzbnet_scan_output_publications_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.gonzbnet_scan_output_publications
    ADD CONSTRAINT gonzbnet_scan_output_publications_pkey PRIMARY KEY (scan_id, pool_id);


--
-- Name: gonzbnet_scan_outputs gonzbnet_scan_outputs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.gonzbnet_scan_outputs
    ADD CONSTRAINT gonzbnet_scan_outputs_pkey PRIMARY KEY (scan_id);


--
-- Name: health_attestations health_attestations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.health_attestations
    ADD CONSTRAINT health_attestations_pkey PRIMARY KEY (attestation_id);


--
-- Name: indexer_article_cohort_scan_state indexer_article_cohort_scan_state_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.indexer_article_cohort_scan_state
    ADD CONSTRAINT indexer_article_cohort_scan_state_pkey PRIMARY KEY (scan_key);


--
-- Name: indexer_body_request_budget_state indexer_body_request_budget_state_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.indexer_body_request_budget_state
    ADD CONSTRAINT indexer_body_request_budget_state_pkey PRIMARY KEY (budget_key);
...
--
-- Name: indexer_inspection_reconcile_state indexer_inspection_reconcile_state_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.indexer_inspection_reconcile_state
    ADD CONSTRAINT indexer_inspection_reconcile_state_pkey PRIMARY KEY (stage_name);
...
--
-- Name: indexer_scrape_timeframe_progress indexer_scrape_timeframe_progress_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.indexer_scrape_timeframe_progress
    ADD CONSTRAINT indexer_scrape_timeframe_progress_pkey PRIMARY KEY (timeframe_id, provider_id, newsgroup_id);


--
-- Name: indexer_source_bucket_state indexer_source_bucket_state_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.indexer_source_bucket_state
    ADD CONSTRAINT indexer_source_bucket_state_pkey PRIMARY KEY (provider_id, newsgroup_id, source_day);
...
--
-- Name: manifest_availability_attestations manifest_availability_attestations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.manifest_availability_attestations
    ADD CONSTRAINT manifest_availability_attestations_pkey PRIMARY KEY (attestation_id);
...
--
-- Name: pool_members pool_members_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pool_members
    ADD CONSTRAINT pool_members_pkey PRIMARY KEY (pool_id, node_id, role);
...
--
-- Name: resolution_manifests resolution_manifests_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.resolution_manifests
    ADD CONSTRAINT resolution_manifests_pkey PRIMARY KEY (manifest_id);


--
-- Name: role_federation_pool_access role_federation_pool_access_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.role_federation_pool_access
    ADD CONSTRAINT role_federation_pool_access_pkey PRIMARY KEY (role_id, pool_id);


--
-- Name: scanner_capacities scanner_capacities_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scanner_capacities
    ADD CONSTRAINT scanner_capacities_pkey PRIMARY KEY (node_id);


--
-- Name: scanner_heartbeats scanner_heartbeats_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scanner_heartbeats
    ADD CONSTRAINT scanner_heartbeats_pkey PRIMARY KEY (node_id, pool_id);
...
--
-- Name: tombstone_votes tombstone_votes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tombstone_votes
    ADD CONSTRAINT tombstone_votes_pkey PRIMARY KEY (id);


--
-- Name: tombstone_votes tombstone_votes_source_event_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tombstone_votes
    ADD CONSTRAINT tombstone_votes_source_event_id_key UNIQUE (source_event_id);
...
--
-- Name: trust_pools trust_pools_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trust_pools
    ADD CONSTRAINT trust_pools_pkey PRIMARY KEY (pool_id);
...
--
-- Name: user_federation_pool_access user_federation_pool_access_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_federation_pool_access
    ADD CONSTRAINT user_federation_pool_access_pkey PRIMARY KEY (user_id, pool_id);


--
-- Name: yenc_header_evidence yenc_header_evidence_message_id_provenance_source_node_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.yenc_header_evidence
    ADD CONSTRAINT yenc_header_evidence_message_id_provenance_source_node_id_key UNIQUE (message_id, provenance, source_node_id);


--
-- Name: yenc_header_evidence yenc_header_evidence_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.yenc_header_evidence
    ADD CONSTRAINT yenc_header_evidence_pkey PRIMARY KEY (evidence_id);
...
CREATE INDEX idx_binary_identity_base_stem_lookup ON ONLY public.binary_identity_current USING btree (provider_id, newsgroup_id, lower(btrim(base_stem)), source_posted_at, binary_id) WHERE (btrim(base_stem) <> ''::text);
...
CREATE INDEX binary_identity_current_defau_provider_id_newsgroup_id_lowe_idx ON public.binary_identity_current_default USING btree (provider_id, newsgroup_id, lower(btrim(base_stem)), source_posted_at, binary_id) WHERE (btrim(base_stem) <> ''::text);
...
--
-- Name: idx_binary_inspection_ready_queue_claim; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_binary_inspection_ready_queue_claim ON ONLY public.binary_inspection_ready_queue USING btree (stage_name, status, ready_at, source_updated_at DESC, binary_id DESC);


--
-- Name: binary_inspection_ready_queue_stage_name_status_ready_at_so_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX binary_inspection_ready_queue_stage_name_status_ready_at_so_idx ON public.binary_inspection_ready_queue_default USING btree (stage_name, status, ready_at, source_updated_at DESC, binary_id DESC);
...
--
-- Name: idx_binary_inspections_stage_binary_source; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_binary_inspections_stage_binary_source ON ONLY public.binary_inspections USING btree (stage_name, binary_id, source_posted_at);


--
-- Name: binary_inspections_default_stage_name_binary_id_source_post_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX binary_inspections_default_stage_name_binary_id_source_post_idx ON public.binary_inspections_default USING btree (stage_name, binary_id, source_posted_at);
...
--
-- Name: idx_article_availability_manifest; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_article_availability_manifest ON public.article_availability_attestations USING btree (manifest_id, checked_at DESC);


--
-- Name: idx_article_availability_pool_checked; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_article_availability_pool_checked ON public.article_availability_attestations USING btree (pool_id, checked_at DESC) INCLUDE (status, author_node_id);


--
-- Name: idx_article_availability_release; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_article_availability_release ON public.article_availability_attestations USING btree (release_id, checked_at DESC);
...
--
-- Name: idx_binary_evidence_exchange_diagnostics_recent; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_binary_evidence_exchange_diagnostics_recent ON public.binary_evidence_exchange_diagnostics USING btree (created_at DESC, pool_id, evidence_kind);


--
-- Name: idx_binary_evidence_repair_ready; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_binary_evidence_repair_ready ON public.binary_evidence_repair_work_items USING btree (status, ready_at, binary_id);


--
-- Name: idx_binary_exchange_identities_match; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_binary_exchange_identities_match ON public.binary_exchange_identities USING btree (scheme, match_id);


--
-- Name: idx_binary_peer_segments_effective; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_binary_peer_segments_effective ON public.binary_peer_segments USING btree (binary_id, part_number, acceptance_state);


--
-- Name: idx_binary_peer_segments_source_date; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_binary_peer_segments_source_date ON public.binary_peer_segments USING btree (source_posted_at);


--
-- Name: idx_checksum_attestations_manifest; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_checksum_attestations_manifest ON public.checksum_attestations USING btree (manifest_id, checked_at DESC);


--
-- Name: idx_checksum_attestations_release; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_checksum_attestations_release ON public.checksum_attestations USING btree (release_id, checked_at DESC);


--
-- Name: idx_coverage_assignments_node_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_coverage_assignments_node_status ON public.coverage_assignments USING btree (assigned_node_id, status, priority DESC);


--
-- Name: idx_coverage_claims_active; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_coverage_claims_active ON public.coverage_claims USING btree (pool_id, group_name, expires_at) WHERE (status = 'active'::text);


--
-- Name: idx_coverage_group_observations_pool_group; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_coverage_group_observations_pool_group ON public.coverage_group_observations USING btree (pool_id, group_name, observed_at DESC);


--
-- Name: idx_coverage_range_outcomes_pool_group; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_coverage_range_outcomes_pool_group ON public.coverage_range_outcomes USING btree (pool_id, group_name, occurred_at DESC);
...
--
-- Name: idx_deferred_article_ranges_claimable; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_deferred_article_ranges_claimable ON public.deferred_article_ranges USING btree (priority_score DESC, posted_at_max DESC NULLS LAST, updated_at, id) WHERE (state = 'ready'::text);
...
--
-- Name: idx_federated_manifest_sources_release; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_federated_manifest_sources_release ON public.federated_manifest_sources USING btree (release_id);


--
-- Name: idx_federated_release_cards_normalized_title; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_federated_release_cards_normalized_title ON public.federated_release_cards USING btree (normalized_title);


--
-- Name: idx_federated_release_cards_posted; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_federated_release_cards_posted ON public.federated_release_cards USING btree (posted_at DESC);


--
-- Name: idx_federated_release_cards_resolvable_score; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_federated_release_cards_resolvable_score ON public.federated_release_cards USING btree (resolvable, best_score DESC);


--
-- Name: idx_federated_release_sources_manifest; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_federated_release_sources_manifest ON public.federated_release_sources USING btree (manifest_id);


--
-- Name: idx_federated_release_sources_pool; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_federated_release_sources_pool ON public.federated_release_sources USING btree (pool_id, resolvable);


--
-- Name: idx_federation_activity_rollups_job_time; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_federation_activity_rollups_job_time ON public.federation_activity_rollups USING btree (job, bucket_start DESC);


--
-- Name: idx_federation_activity_rollups_node_time; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_federation_activity_rollups_node_time ON public.federation_activity_rollups USING btree (node_id, bucket_start DESC);


--
-- Name: idx_federation_activity_rollups_pool_time; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_federation_activity_rollups_pool_time ON public.federation_activity_rollups USING btree (pool_id, bucket_start DESC);


--
-- Name: idx_federation_event_chain_issues_open; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_federation_event_chain_issues_open ON public.federation_event_chain_issues USING btree (author_node_id, issue_type, detected_at DESC) WHERE (resolved_at IS NULL);


--
-- Name: idx_federation_events_accepted_received; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_federation_events_accepted_received ON public.federation_events USING btree (received_at DESC, author_node_id) WHERE (validation_status = 'accepted'::text);


--
-- Name: idx_federation_events_outbox; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_federation_events_outbox ON public.federation_events USING btree (created_at, event_id) WHERE ((validation_status = 'accepted'::text) AND (visibility <> 'local'::text));


--
-- Name: idx_federation_events_pool_ids_gin; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_federation_events_pool_ids_gin ON public.federation_events USING gin (pool_ids);


--
-- Name: idx_federation_events_revoked_subject; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_federation_events_revoked_subject ON public.federation_events USING btree (((body_json ->> 'subject_node_id'::text)), created_at, event_id) WHERE ((validation_status = 'accepted'::text) AND (event_type = 'PoolMemberRevoked'::text));


--
-- Name: idx_federation_events_type_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_federation_events_type_created ON public.federation_events USING btree (event_type, created_at DESC);


--
-- Name: idx_federation_nodes_handshake_expiry; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_federation_nodes_handshake_expiry ON public.federation_nodes USING btree (last_seen_at) WHERE (status = 'handshaken'::text);
...
--
-- Name: idx_federation_nonce_expires; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_federation_nonce_expires ON public.federation_nonce_replay_cache USING btree (expires_at);


--
-- Name: idx_federation_peer_deliveries_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_federation_peer_deliveries_status ON public.federation_peer_deliveries USING btree (peer_id, status, updated_at);


--
-- Name: idx_federation_peers_enabled_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_federation_peers_enabled_status ON public.federation_peers USING btree (enabled, status);


--
-- Name: idx_federation_pending_projections_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_federation_pending_projections_status ON public.federation_pending_projections USING btree (status, last_attempt_at);


--
-- Name: idx_federation_pool_admissions_candidate; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_federation_pool_admissions_candidate ON public.federation_pool_admissions USING btree (candidate_node_id, status, created_at DESC);


--
-- Name: idx_federation_pool_admissions_pool_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_federation_pool_admissions_pool_status ON public.federation_pool_admissions USING btree (pool_id, status, created_at DESC);


--
-- Name: idx_federation_rejected_events_received; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_federation_rejected_events_received ON public.federation_rejected_events USING btree (received_at DESC);


--
-- Name: idx_federation_validation_tasks_ready; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_federation_validation_tasks_ready ON public.federation_validation_tasks USING btree (status, due_at, priority DESC);


--
-- Name: idx_gonzbnet_scan_output_publications_pool; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_gonzbnet_scan_output_publications_pool ON public.gonzbnet_scan_output_publications USING btree (pool_id, published_at DESC);


--
-- Name: idx_gonzbnet_scan_outputs_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_gonzbnet_scan_outputs_status ON public.gonzbnet_scan_outputs USING btree (status, updated_at);


--
-- Name: idx_health_attestations_manifest; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_health_attestations_manifest ON public.health_attestations USING btree (manifest_id, checked_at DESC);


--
-- Name: idx_health_attestations_pool; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_health_attestations_pool ON public.health_attestations USING btree (pool_id, release_id);


--
-- Name: idx_health_attestations_pool_checked; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_health_attestations_pool_checked ON public.health_attestations USING btree (pool_id, checked_at DESC) INCLUDE (status, author_node_id);


--
-- Name: idx_health_attestations_release; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_health_attestations_release ON public.health_attestations USING btree (release_id, checked_at DESC);
...
--
-- Name: idx_indexer_scrape_timeframe_progress_active; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_indexer_scrape_timeframe_progress_active ON public.indexer_scrape_timeframe_progress USING btree (state, updated_at, timeframe_id) WHERE (state = ANY (ARRAY['pending'::text, 'active'::text, 'failed'::text]));


--
-- Name: idx_indexer_source_bucket_state_progress; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_indexer_source_bucket_state_progress ON public.indexer_source_bucket_state USING btree (last_progress_at, last_ingested_at, source_day) WHERE (state = 'active'::text);


--
-- Name: idx_indexer_source_bucket_state_retention; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_indexer_source_bucket_state_retention ON public.indexer_source_bucket_state USING btree (state, purge_eligible_at, source_day, provider_id, newsgroup_id) WHERE (state = ANY (ARRAY['success'::text, 'no_yield'::text, 'purge_eligible'::text]));
...
--
-- Name: idx_manifest_availability_manifest; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_manifest_availability_manifest ON public.manifest_availability_attestations USING btree (manifest_id, checked_at DESC);


--
-- Name: idx_manifest_availability_release; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_manifest_availability_release ON public.manifest_availability_attestations USING btree (release_id, checked_at DESC);
...
--
-- Name: idx_pool_members_capabilities; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_pool_members_capabilities ON public.pool_members USING gin (allowed_capabilities);


--
-- Name: idx_pool_members_node; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_pool_members_node ON public.pool_members USING btree (node_id, status);


--
-- Name: idx_pool_members_pool_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_pool_members_pool_status ON public.pool_members USING btree (pool_id, status, role);
...
--
-- Name: idx_releases_inspection_reconcile; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_releases_inspection_reconcile ON public.releases USING btree (updated_at, release_id);
...
--
-- Name: idx_reputation_events_node; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_reputation_events_node ON public.reputation_events USING btree (node_id, created_at DESC);


--
-- Name: idx_resolution_manifests_release; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_resolution_manifests_release ON public.resolution_manifests USING btree (release_id);


--
-- Name: idx_role_federation_pool_access_search; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_role_federation_pool_access_search ON public.role_federation_pool_access USING btree (role_id, pool_id) WHERE (can_search = true);


--
-- Name: idx_scanner_heartbeats_pool_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_scanner_heartbeats_pool_status ON public.scanner_heartbeats USING btree (pool_id, status, published_at DESC);
...
--
-- Name: idx_tombstone_votes_target; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_tombstone_votes_target ON public.tombstone_votes USING btree (target_type, target_id, pool_id);


--
-- Name: idx_tombstones_active_target; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_tombstones_active_target ON public.tombstones USING btree (active, target_type, target_id);


--
-- Name: idx_tombstones_unique_target; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_tombstones_unique_target ON public.tombstones USING btree (target_type, target_id, COALESCE(pool_id, '__local__'::text));


--
-- Name: idx_trust_pools_enabled; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_trust_pools_enabled ON public.trust_pools USING btree (enabled);


--
-- Name: idx_user_federation_pool_access_search; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_user_federation_pool_access_search ON public.user_federation_pool_access USING btree (user_id, pool_id) WHERE (can_search = true);


--
-- Name: idx_yenc_header_evidence_message; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_yenc_header_evidence_message ON public.yenc_header_evidence USING btree (message_id, acceptance_state);


--
-- Name: idx_yenc_header_evidence_source_date; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_yenc_header_evidence_source_date ON public.yenc_header_evidence USING btree (source_posted_at);


--
-- Name: idx_yenc_header_evidence_source_message; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_yenc_header_evidence_source_message ON public.yenc_header_evidence USING btree (source_posted_at, message_id);
...
--
-- Name: binary_inspection_ready_queue_stage_name_status_ready_at_so_idx; Type: INDEX ATTACH; Schema: public; Owner: -
--

ALTER INDEX public.idx_binary_inspection_ready_queue_claim ATTACH PARTITION public.binary_inspection_ready_queue_stage_name_status_ready_at_so_idx;
...
--
-- Name: binary_inspections_default_stage_name_binary_id_source_post_idx; Type: INDEX ATTACH; Schema: public; Owner: -
--

ALTER INDEX public.idx_binary_inspections_stage_binary_source ATTACH PARTITION public.binary_inspections_default_stage_name_binary_id_source_post_idx;
...
--
-- Name: article_availability_attestations article_availability_attestations_author_node_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.article_availability_attestations
    ADD CONSTRAINT article_availability_attestations_author_node_id_fkey FOREIGN KEY (author_node_id) REFERENCES public.federation_nodes(node_id);


--
-- Name: article_availability_attestations article_availability_attestations_source_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.article_availability_attestations
    ADD CONSTRAINT article_availability_attestations_source_event_id_fkey FOREIGN KEY (source_event_id) REFERENCES public.federation_events(event_id);
...
--
-- Name: binary_evidence_repair_work_items binary_evidence_repair_work_items_binary_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.binary_evidence_repair_work_items
    ADD CONSTRAINT binary_evidence_repair_work_items_binary_id_fkey FOREIGN KEY (binary_id) REFERENCES public.binary_core(binary_id) ON DELETE CASCADE;


--
-- Name: binary_exchange_identities binary_exchange_identities_binary_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.binary_exchange_identities
    ADD CONSTRAINT binary_exchange_identities_binary_id_fkey FOREIGN KEY (binary_id) REFERENCES public.binary_core(binary_id) ON DELETE CASCADE;
...
--
-- Name: binary_peer_segments binary_peer_segments_binary_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.binary_peer_segments
    ADD CONSTRAINT binary_peer_segments_binary_id_fkey FOREIGN KEY (binary_id) REFERENCES public.binary_core(binary_id) ON DELETE CASCADE;
...
--
-- Name: checksum_attestations checksum_attestations_author_node_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.checksum_attestations
    ADD CONSTRAINT checksum_attestations_author_node_id_fkey FOREIGN KEY (author_node_id) REFERENCES public.federation_nodes(node_id);


--
-- Name: checksum_attestations checksum_attestations_source_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.checksum_attestations
    ADD CONSTRAINT checksum_attestations_source_event_id_fkey FOREIGN KEY (source_event_id) REFERENCES public.federation_events(event_id);


--
-- Name: coverage_assignments coverage_assignments_author_node_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coverage_assignments
    ADD CONSTRAINT coverage_assignments_author_node_id_fkey FOREIGN KEY (author_node_id) REFERENCES public.federation_nodes(node_id);


--
-- Name: coverage_assignments coverage_assignments_source_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coverage_assignments
    ADD CONSTRAINT coverage_assignments_source_event_id_fkey FOREIGN KEY (source_event_id) REFERENCES public.federation_events(event_id);


--
-- Name: coverage_checkpoints coverage_checkpoints_author_node_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coverage_checkpoints
    ADD CONSTRAINT coverage_checkpoints_author_node_id_fkey FOREIGN KEY (author_node_id) REFERENCES public.federation_nodes(node_id);


--
-- Name: coverage_checkpoints coverage_checkpoints_source_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coverage_checkpoints
    ADD CONSTRAINT coverage_checkpoints_source_event_id_fkey FOREIGN KEY (source_event_id) REFERENCES public.federation_events(event_id);


--
-- Name: coverage_claims coverage_claims_author_node_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coverage_claims
    ADD CONSTRAINT coverage_claims_author_node_id_fkey FOREIGN KEY (author_node_id) REFERENCES public.federation_nodes(node_id);


--
-- Name: coverage_claims coverage_claims_source_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coverage_claims
    ADD CONSTRAINT coverage_claims_source_event_id_fkey FOREIGN KEY (source_event_id) REFERENCES public.federation_events(event_id);


--
-- Name: coverage_group_observations coverage_group_observations_author_node_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coverage_group_observations
    ADD CONSTRAINT coverage_group_observations_author_node_id_fkey FOREIGN KEY (author_node_id) REFERENCES public.federation_nodes(node_id);


--
-- Name: coverage_group_observations coverage_group_observations_source_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coverage_group_observations
    ADD CONSTRAINT coverage_group_observations_source_event_id_fkey FOREIGN KEY (source_event_id) REFERENCES public.federation_events(event_id);


--
-- Name: coverage_plans coverage_plans_author_node_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coverage_plans
    ADD CONSTRAINT coverage_plans_author_node_id_fkey FOREIGN KEY (author_node_id) REFERENCES public.federation_nodes(node_id);


--
-- Name: coverage_plans coverage_plans_source_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coverage_plans
    ADD CONSTRAINT coverage_plans_source_event_id_fkey FOREIGN KEY (source_event_id) REFERENCES public.federation_events(event_id);


--
-- Name: coverage_range_outcomes coverage_range_outcomes_author_node_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coverage_range_outcomes
    ADD CONSTRAINT coverage_range_outcomes_author_node_id_fkey FOREIGN KEY (author_node_id) REFERENCES public.federation_nodes(node_id);


--
-- Name: coverage_range_outcomes coverage_range_outcomes_source_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coverage_range_outcomes
    ADD CONSTRAINT coverage_range_outcomes_source_event_id_fkey FOREIGN KEY (source_event_id) REFERENCES public.federation_events(event_id);


--
-- Name: coverage_stale_claim_penalties coverage_stale_claim_penalties_node_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.coverage_stale_claim_penalties
    ADD CONSTRAINT coverage_stale_claim_penalties_node_id_fkey FOREIGN KEY (node_id) REFERENCES public.federation_nodes(node_id);
...
--
-- Name: federated_manifest_sources federated_manifest_sources_source_node_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federated_manifest_sources
    ADD CONSTRAINT federated_manifest_sources_source_node_id_fkey FOREIGN KEY (source_node_id) REFERENCES public.federation_nodes(node_id);


--
-- Name: federated_release_cards federated_release_cards_source_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federated_release_cards
    ADD CONSTRAINT federated_release_cards_source_event_id_fkey FOREIGN KEY (source_event_id) REFERENCES public.federation_events(event_id);


--
-- Name: federated_release_sources federated_release_sources_release_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federated_release_sources
    ADD CONSTRAINT federated_release_sources_release_id_fkey FOREIGN KEY (release_id) REFERENCES public.federated_release_cards(release_id) ON DELETE CASCADE;


--
-- Name: federated_release_sources federated_release_sources_source_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federated_release_sources
    ADD CONSTRAINT federated_release_sources_source_event_id_fkey FOREIGN KEY (source_event_id) REFERENCES public.federation_events(event_id);


--
-- Name: federated_release_sources federated_release_sources_source_node_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federated_release_sources
    ADD CONSTRAINT federated_release_sources_source_node_id_fkey FOREIGN KEY (source_node_id) REFERENCES public.federation_nodes(node_id);


--
-- Name: federation_node_capabilities federation_node_capabilities_node_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_node_capabilities
    ADD CONSTRAINT federation_node_capabilities_node_id_fkey FOREIGN KEY (node_id) REFERENCES public.federation_nodes(node_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.federation_peer_cursors
    ADD CONSTRAINT federation_peer_cursors_peer_id_fkey FOREIGN KEY (peer_id) REFERENCES public.federation_peers(id) ON DELETE CASCADE;


--
-- Name: federation_peer_deliveries federation_peer_deliveries_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_peer_deliveries
    ADD CONSTRAINT federation_peer_deliveries_event_id_fkey FOREIGN KEY (event_id) REFERENCES public.federation_events(event_id) ON DELETE CASCADE;


--
-- Name: federation_peer_deliveries federation_peer_deliveries_peer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_peer_deliveries
    ADD CONSTRAINT federation_peer_deliveries_peer_id_fkey FOREIGN KEY (peer_id) REFERENCES public.federation_peers(id) ON DELETE CASCADE;


--
-- Name: federation_peers federation_peers_node_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_peers
    ADD CONSTRAINT federation_peers_node_id_fkey FOREIGN KEY (node_id) REFERENCES public.federation_nodes(node_id);


--
-- Name: federation_pending_projections federation_pending_projections_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_pending_projections
    ADD CONSTRAINT federation_pending_projections_event_id_fkey FOREIGN KEY (event_id) REFERENCES public.federation_events(event_id) ON DELETE CASCADE;


--
-- Name: federation_pool_admissions federation_pool_admissions_candidate_node_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_pool_admissions
    ADD CONSTRAINT federation_pool_admissions_candidate_node_id_fkey FOREIGN KEY (candidate_node_id) REFERENCES public.federation_nodes(node_id);


--
-- Name: federation_pool_admissions federation_pool_admissions_final_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_pool_admissions
    ADD CONSTRAINT federation_pool_admissions_final_event_id_fkey FOREIGN KEY (final_event_id) REFERENCES public.federation_events(event_id);


--
-- Name: federation_pool_admissions federation_pool_admissions_proposal_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_pool_admissions
    ADD CONSTRAINT federation_pool_admissions_proposal_event_id_fkey FOREIGN KEY (proposal_event_id) REFERENCES public.federation_events(event_id) ON DELETE CASCADE;


--
-- Name: federation_pool_approval_fragments federation_pool_approval_fragments_admin_node_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_pool_approval_fragments
    ADD CONSTRAINT federation_pool_approval_fragments_admin_node_id_fkey FOREIGN KEY (admin_node_id) REFERENCES public.federation_nodes(node_id);


--
-- Name: federation_pool_approval_fragments federation_pool_approval_fragments_proposal_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_pool_approval_fragments
    ADD CONSTRAINT federation_pool_approval_fragments_proposal_event_id_fkey FOREIGN KEY (proposal_event_id) REFERENCES public.federation_pool_admissions(proposal_event_id) ON DELETE CASCADE;


--
-- Name: federation_validation_tasks federation_validation_tasks_manifest_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_validation_tasks
    ADD CONSTRAINT federation_validation_tasks_manifest_id_fkey FOREIGN KEY (manifest_id) REFERENCES public.resolution_manifests(manifest_id) ON DELETE CASCADE;


--
-- Name: federation_validation_tasks federation_validation_tasks_source_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_validation_tasks
    ADD CONSTRAINT federation_validation_tasks_source_event_id_fkey FOREIGN KEY (source_event_id) REFERENCES public.federation_events(event_id);


--
-- Name: federation_validation_tasks federation_validation_tasks_source_node_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.federation_validation_tasks
    ADD CONSTRAINT federation_validation_tasks_source_node_id_fkey FOREIGN KEY (source_node_id) REFERENCES public.federation_nodes(node_id);


--
-- Name: gonzbnet_scan_output_publications gonzbnet_scan_output_publications_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.gonzbnet_scan_output_publications
    ADD CONSTRAINT gonzbnet_scan_output_publications_event_id_fkey FOREIGN KEY (event_id) REFERENCES public.federation_events(event_id);


--
-- Name: gonzbnet_scan_output_publications gonzbnet_scan_output_publications_scan_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.gonzbnet_scan_output_publications
    ADD CONSTRAINT gonzbnet_scan_output_publications_scan_id_fkey FOREIGN KEY (scan_id) REFERENCES public.gonzbnet_scan_outputs(scan_id) ON DELETE CASCADE;


--
-- Name: gonzbnet_scan_outputs gonzbnet_scan_outputs_published_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.gonzbnet_scan_outputs
    ADD CONSTRAINT gonzbnet_scan_outputs_published_event_id_fkey FOREIGN KEY (published_event_id) REFERENCES public.federation_events(event_id);


--
-- Name: health_attestations health_attestations_author_node_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.health_attestations
    ADD CONSTRAINT health_attestations_author_node_id_fkey FOREIGN KEY (author_node_id) REFERENCES public.federation_nodes(node_id);


--
-- Name: health_attestations health_attestations_source_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.health_attestations
    ADD CONSTRAINT health_attestations_source_event_id_fkey FOREIGN KEY (source_event_id) REFERENCES public.federation_events(event_id);
...
--
-- Name: indexer_scrape_timeframe_progress indexer_scrape_timeframe_progress_newsgroup_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.indexer_scrape_timeframe_progress
    ADD CONSTRAINT indexer_scrape_timeframe_progress_newsgroup_id_fkey FOREIGN KEY (newsgroup_id) REFERENCES public.newsgroups(id) ON DELETE CASCADE;


--
-- Name: indexer_scrape_timeframe_progress indexer_scrape_timeframe_progress_provider_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.indexer_scrape_timeframe_progress
    ADD CONSTRAINT indexer_scrape_timeframe_progress_provider_id_fkey FOREIGN KEY (provider_id) REFERENCES public.usenet_providers(id) ON DELETE CASCADE;


--
-- Name: indexer_source_bucket_state indexer_source_bucket_state_newsgroup_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.indexer_source_bucket_state
    ADD CONSTRAINT indexer_source_bucket_state_newsgroup_id_fkey FOREIGN KEY (newsgroup_id) REFERENCES public.newsgroups(id) ON DELETE CASCADE;


--
-- Name: indexer_source_bucket_state indexer_source_bucket_state_provider_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.indexer_source_bucket_state
    ADD CONSTRAINT indexer_source_bucket_state_provider_id_fkey FOREIGN KEY (provider_id) REFERENCES public.usenet_providers(id) ON DELETE CASCADE;
...
--
-- Name: manifest_availability_attestations manifest_availability_attestations_author_node_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.manifest_availability_attestations
    ADD CONSTRAINT manifest_availability_attestations_author_node_id_fkey FOREIGN KEY (author_node_id) REFERENCES public.federation_nodes(node_id);


--
-- Name: manifest_availability_attestations manifest_availability_attestations_source_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.manifest_availability_attestations
    ADD CONSTRAINT manifest_availability_attestations_source_event_id_fkey FOREIGN KEY (source_event_id) REFERENCES public.federation_events(event_id);
...
--
-- Name: pool_members pool_members_approved_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pool_members
    ADD CONSTRAINT pool_members_approved_event_id_fkey FOREIGN KEY (approved_event_id) REFERENCES public.federation_events(event_id);


--
-- Name: pool_members pool_members_node_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pool_members
    ADD CONSTRAINT pool_members_node_id_fkey FOREIGN KEY (node_id) REFERENCES public.federation_nodes(node_id);


--
-- Name: pool_members pool_members_pool_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pool_members
    ADD CONSTRAINT pool_members_pool_id_fkey FOREIGN KEY (pool_id) REFERENCES public.trust_pools(pool_id) ON DELETE CASCADE;


--
-- Name: pool_members pool_members_revoked_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pool_members
    ADD CONSTRAINT pool_members_revoked_event_id_fkey FOREIGN KEY (revoked_event_id) REFERENCES public.federation_events(event_id);
...
--
-- Name: reputation_events reputation_events_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.reputation_events
    ADD CONSTRAINT reputation_events_event_id_fkey FOREIGN KEY (event_id) REFERENCES public.federation_events(event_id);


--
-- Name: reputation_events reputation_events_node_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.reputation_events
    ADD CONSTRAINT reputation_events_node_id_fkey FOREIGN KEY (node_id) REFERENCES public.federation_nodes(node_id);


--
-- Name: resolution_manifests resolution_manifests_source_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.resolution_manifests
    ADD CONSTRAINT resolution_manifests_source_event_id_fkey FOREIGN KEY (source_event_id) REFERENCES public.federation_events(event_id);


--
-- Name: resolution_manifests resolution_manifests_source_node_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.resolution_manifests
    ADD CONSTRAINT resolution_manifests_source_node_id_fkey FOREIGN KEY (source_node_id) REFERENCES public.federation_nodes(node_id);


--
-- Name: scanner_capacities scanner_capacities_node_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scanner_capacities
    ADD CONSTRAINT scanner_capacities_node_id_fkey FOREIGN KEY (node_id) REFERENCES public.federation_nodes(node_id) ON DELETE CASCADE;


--
-- Name: scanner_capacities scanner_capacities_source_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scanner_capacities
    ADD CONSTRAINT scanner_capacities_source_event_id_fkey FOREIGN KEY (source_event_id) REFERENCES public.federation_events(event_id);


--
-- Name: scanner_heartbeats scanner_heartbeats_node_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scanner_heartbeats
    ADD CONSTRAINT scanner_heartbeats_node_id_fkey FOREIGN KEY (node_id) REFERENCES public.federation_nodes(node_id) ON DELETE CASCADE;


--
-- Name: scanner_heartbeats scanner_heartbeats_source_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.scanner_heartbeats
    ADD CONSTRAINT scanner_heartbeats_source_event_id_fkey FOREIGN KEY (source_event_id) REFERENCES public.federation_events(event_id);
...
--
-- Name: tombstone_votes tombstone_votes_author_node_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tombstone_votes
    ADD CONSTRAINT tombstone_votes_author_node_id_fkey FOREIGN KEY (author_node_id) REFERENCES public.federation_nodes(node_id);


--
-- Name: tombstone_votes tombstone_votes_source_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tombstone_votes
    ADD CONSTRAINT tombstone_votes_source_event_id_fkey FOREIGN KEY (source_event_id) REFERENCES public.federation_events(event_id);


--
-- Name: tombstones tombstones_source_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tombstones
    ADD CONSTRAINT tombstones_source_event_id_fkey FOREIGN KEY (source_event_id) REFERENCES public.federation_events(event_id);


--
-- Name: trust_pools trust_pools_genesis_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trust_pools
    ADD CONSTRAINT trust_pools_genesis_event_id_fkey FOREIGN KEY (genesis_event_id) REFERENCES public.federation_events(event_id);
