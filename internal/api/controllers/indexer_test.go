...
func (t *testRuntimeIndexerService) AssembleLaneAOnce(context.Context) error         { return nil }
func (t *testRuntimeIndexerService) AssembleLaneBOnce(context.Context) error         { return nil }
