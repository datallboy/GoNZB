...
This doc is the current whole-system schema map for the database growth-trim sprint.
...
This doc is intentionally current-state oriented. Use `docs/active/INDEXER_DATABASE_SCHEMA_AUDIT.md` for live column-by-column audit detail and `docs/active/INDEXER_DATABASE_GROWTH_TRIM_PLAN.md` for the execution sequence.
