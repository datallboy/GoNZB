...
Representative anonymized sample:

- `SyntheticOpaqueToken01.bin`
- `SyntheticOpaqueToken02.bin`
- `SyntheticOpaqueToken03.bin`
...
- `SyntheticArchiveToken.r07`
- `SyntheticOpaqueToken04.bin`
- `SyntheticOpaqueToken05.bin`
...
Representative anonymized family:

- `example poster provider alt binaries example one release files 60`
- summary row:
  - `binary_count=1397`
  - `complete_main_payload_binary_count=2`
