...
This directory is the repository-only development reference for GoNZBNet. It
is intentionally excluded from the public documentation site. Operator
guidance lives in the [public GoNZBNet guide](../../modules/gonzbnet.md).
