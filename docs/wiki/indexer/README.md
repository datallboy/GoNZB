...
This directory is the repository-only development reference for indexer design
and operations. It is intentionally excluded from the public documentation
site. Operator guidance lives in the
[public indexer guide](../../modules/indexer.md).
