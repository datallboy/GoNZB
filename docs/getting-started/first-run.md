...
up. The [Indexer operations guide](../wiki/indexer/operations-playbook.md)
explains backlogs and health checks.
...
[private pool quickstart](../wiki/gonzbnet/private-pool-quickstart.md).
