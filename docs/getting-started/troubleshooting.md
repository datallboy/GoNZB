...
See the [Usenet indexer guide](../modules/indexer.md) before increasing
recovery depth or stage concurrency.
...
Use the [GoNZBNet overview](../modules/gonzbnet.md) for role-specific checks.
